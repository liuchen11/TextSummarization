...
class naive_extractor(base_net):
    ...
    def __init__(self, hyper_params):
        ...
        self.name='naive extraction model' if not 'name' in hyper_params else hyper_params['name']
        ...
        unnormalized_prediction=self.mlp(input_data=current_embedding, hidden_sizes=[self.feature_map,]+self.hidden_sizes,
